...
class _AddEditTaskScreenState extends State<AddEditTaskScreen> {
  ...
  late TaskDetailViewModel? _taskDetailViewModel;
  ...
  void _loadTaskData() {
    ...
    _taskDetailViewModel = Provider.of<TaskDetailViewModel>(context, listen: false);
    final task = _taskDetailViewModel!.task;
  ...
  void _saveTask() {
    ...
    if (widget.taskId == null) {
      // Create new task
      Provider.of<TaskListViewModel>(context, listen: false).addTask(
      ...
      _taskDetailViewModel!.updateTask(
        title: _titleController.text,
        description: _descriptionController.text,
        dueDate: dueDate,
        priority: _selectedPriority,
        reminderTime: _selectedReminderDateTime,
      );
      
      // Handle subtasks separately since we need to preserve IDs
      // This would require additional logic in the view model
    }
            ...
            InkWell(
              ...
              child: InputDecorator(
                decoration: InputDecoration(
                  ...
                  suffixIcon: _selectedReminderDateTime != null
                      ? IconButton(
